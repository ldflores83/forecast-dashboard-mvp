...
bu_summary AS (
  SELECT
    ...
    COUNTIF(o.IsClosed AND o.Is_Won AND o.Sales_Motion IN ('Net New','Expansion','Migration') AND o.Category = 'Solutions')   AS won_count,
    COUNTIF(o.IsClosed AND o.Sales_Motion IN ('Net New','Expansion','Migration') AND o.Category = 'Solutions')                AS closed_count,
    COALESCE(SUM(CASE WHEN o.Is_Won AND o.Sales_Motion IN ('Net New','Expansion','Migration') AND o.Category = 'Solutions' THEN o.ACV_USD END), 0) AS won_acv,

    -- Avg deal (won only)
    SAFE_DIVIDE(
      SUM(CASE WHEN o.Is_Won AND o.Sales_Motion IN ('Net New','Expansion','Migration') AND o.Category = 'Solutions' THEN o.ACV_USD END),
      NULLIF(COUNTIF(o.Is_Won AND o.Sales_Motion IN ('Net New','Expansion','Migration') AND o.Category = 'Solutions'), 0)
    )                                                                     AS avg_deal_won,
